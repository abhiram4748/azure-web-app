-- Create Users Table (ID is Firebase UID)
CREATE TABLE Users (
...
-- Create ProductSizes Table (Many-to-Many relationship for sizes)
...
CREATE TABLE Orders (
    ...
    user_id NVARCHAR(128) FOREIGN KEY REFERENCES Users(id),
...
-- Seed Initial Products (based on src/data/products.js)
